        ...
        <div class="upper-footer">
            ...
            <div class="esquerda">
                ...
                <div class="social-footer">
                    ...
                    <a href="https://www.instagram.com/clinicabrunopedro/"><img src="{{ asset('img/insta-branco.svg') }}" alt="instagram icon"></a>
                    <a href="https://www.facebook.com/profile.php?id=100054419142752"><img src="{{ asset('img/facebook-branco.svg') }}" alt="facebook icon"></a>
                </div>
            </div>
